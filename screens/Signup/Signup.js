                    ...
                    >
                        {({ handleChange, handleBlur, handleSubmit, values }) =>
                            <View style={StyledFormArea}>
                                <TouchableOpacity google={true} style={GoogleBtn} onPress={handleSubmit}>
                                    <Fontisto name="google" style={LeftIcon} color={secondary} size={25} />
                                    <Text google={true} style={ButtonTextGoogle}>Inscrivez vous avec google</Text>
                                </TouchableOpacity>
